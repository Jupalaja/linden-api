...
from .handler import handle_usuario_administrativo
...
@router.post("/usuario-administrativo", response_model=InteractionResponse)
async def handle(
    ...
    """
    Handles a user-assistant interaction for an administrative user,
