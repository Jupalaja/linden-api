...
INSTRUCTION_ASK_USER_DATA = "Acknowledge the user's last message and confirm you can help. Then, politely ask for their name and email address before continuing. For example: 'I'll be glad to assist you. Before we continue, who do I have the pleasure of speaking with? Could you also share your email address?'"
