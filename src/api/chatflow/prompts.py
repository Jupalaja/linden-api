...
PROMPT_OUT_OF_SCOPE_QUESTION = "That’s a great question. I’m not able to answer it directly, but our doctors would be happy to help. You can schedule a free 15-minute discovery call here: **[Link to Book a Discovery Call](https://ayanaturopathicmedicine.practicebetter.io/#/66fb4a41904772d2c40fe3fc/bookings?r=6706dd2ad30b811dc03d2644&step=services)** \nYou can also reach out to our team by phone or email!"
...
INSTRUCTION_FOR_ACKNOWLEDGEMENT = "Based on the user's last message, provide a brief, one-sentence acknowledgment to show you have understood. For example: 'Thanks for sharing that.', 'I understand, no worries', or 'Thank you, [Name]'. Your acknowledgement MUST be a single sentence. It MUST NOT contain any questions, ask for information, or provide any new information. It should only confirm receipt of their message. Do not make any statements or offer any suggestions. IMPORTANT: Do NOT say you cannot help or cannot perform an action. The system will strictly follow this acknowledgment with the requested action or link (which is provided in the context as 'UPCOMING SYSTEM MESSAGE')."
