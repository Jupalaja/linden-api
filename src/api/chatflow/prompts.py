...
INSTRUCTION_FOR_ACKNOWLEDGEMENT = "Based on the user's last message, provide a brief, one-sentence acknowledgment to show you have understood. For example: 'Thanks for sharing that.' or 'I understand, no worries'. Your acknowledgement MUST be a single sentence. It MUST NOT contain any questions, ask for information, or provide any new information. It should only confirm receipt of their message. Do not make any statements or offer any suggestions, as the next message will provide all necessary details."
