...
def classify_intent(intent: ConversationType) -> ConversationType:
    ...
    - is_frequently_asked_question: User asks specific common questions about insurance, pricing, location, or services. A general inquiry about services like "I'd like to know more about your services" falls into this category.
...
def send_book_call_link() -> str:
    ...
    """
    return "Here's the [Book Call Link](https://ayanaturopathicmedicine.practicebetter.io/#/66fb4a41904772d2c40fe3fc/bookings?r=6706dd2ad30b811dc03d2644&step=services)"
